...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_TILD, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,       KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC,          TO(2),   KC_PSLS, KC_PAST, KC_PSCR, \
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,       KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,                            KC_1,    KC_2,    KC_3,             \
                                                                                                                                TD_UP,                                       KC_PENT, \
        KC_LCTL, KC_LGUI, KC_LALT,                   JT_SP1,                                KC_RALT, JT_AP3,                                               KC_0,    KC_PDOT,          \
                                                                                                                        TD_LF,  TD_DN, TD_RG                                     \
    ),
    [1] = LAYOUT(
        _______, MEH(KC_1),MEH(KC_2),MEH(KC_3),MEH(KC_4),MEH(KC_5),MEH(KC_6),MEH(KC_7),MEH(KC_8),MEH(KC_9),MEH(KC_0),_______, _______, KC_INS,     KC_MPLY, KC_MSTP, KC_VOLU, KC_MUTE, \
        KC_GRV,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,  KC_F12,  _______,    KC_MPRV, KC_MNXT, KC_VOLD, KC_SLCK, \
        KC_TILD, _______,  C(KC_W),  _______,  C(KC_R),  C(KC_T),  _______,  _______,  U_T_AGCR, _______,  _______,  _______, _______, _______,    _______, _______, _______, _______, \
        ...
        _______, C(KC_Z),  C(KC_V),  C(KC_C),  C(KC_V),  _______,  _______,  _______,  _______,  _______,  _______,  _______,                      _______, _______, _______,          \
                                                                                                                              KC_PGUP,                                        _______, \
    ...
    [2] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,              _______, KC_PSLS, KC_PAST, KC_PSCR, \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_SLEP,              KC_P7,   KC_P8,   KC_P9,   KC_PMNS, \
    ...
    [3] = LAYOUT(
        ...
        _______, L_T_MD,  L_T_ONF, _______, L_EDG_M, MD_BOOT, TG_NKRO, _______, _______,  _______, _______, _______,                            KC_P1,   KC_P2,   KC_P3,            \
                                                                                                                             _______,                                     KC_PENT, \
        _______, _______, _______,                   DBG_FAC,                            _______, _______,                                              KC_P0,   KC_PDOT,          \
                                                                                                                    _______, _______, _______                                      \
    ),
